...
local success, response = exports.LGF_Inventory:registerTempStash(inventoryId, data)
...
```lua copy
local success, response = exports.LGF_Inventory:registerTempStash("stash_001", {
