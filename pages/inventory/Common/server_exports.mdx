...
RegisterCommand("testDurability", function(source)
    local weaponData = exports.LGF_Inventory:getWeaponData() -- Shared Export
    ...
    if weaponData and weaponData.metadata and weaponData.metadata.durability then
        ...
        local success, message, newValue = exports.LGF_Inventory:setDurability(source, itemName, metadata, slot, value)
