...
<Tabs items={["Click"]} defaultIndex="1">
  <Tabs.Tab>
      ```lua copy
...
<Tabs items={["Server"]} defaultIndex="1">
  <Tabs.Tab>
    ```lua copy
    ---@param target | string 
    ---@param props | table The props of the vehicle 
    ---@param stored | number The state of the vehicle
...
<Tabs items={["Server"]} defaultIndex="1">
  <Tabs.Tab>
    ```lua copy
    ---@param target | string 
    ---@param amount | number The quantity to Manage for the account 
    ---@typetransition amount | string  ("add" or "remove")
    LGF.Core:ManageAccount(target, amount, typetransition)
    ```
  </Tabs.Tab>
</Tabs>
...
<Tabs items={["Client", "Server"]} defaultIndex="1">
  ...
  <Tabs.Tab>
    ```lua copy 
    ---@param source 
    local gender = LGF.Core:GetGender(source)
     ```
  </Tabs.Tab>
</Tabs>
#### Returns
